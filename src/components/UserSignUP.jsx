            ...
            <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-indigo-700 text-white">
                ...
                <form action="" className="space-y-12 ng-untouched ng-pristine ng-valid">
                    ...
                    <div className="space-y-2">
                        <div>
                            <button type="button" className="w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-400 text-white">Sign UP</button>
                        </div>
                        <p className="px-6 text-sm text-center text-white">Already have an account?
                            <Link to="/login" className="hover:underline dark:text-violet-400 ml-1">Sign up</Link>.
                        </p>
                    </div>
                </form>
            </div>
