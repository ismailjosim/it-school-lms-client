        ...
        <div className=" p-5 mx-auto sm:p-10 md:p-16">
            <div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded relative">
                <Pdf targetRef={ref} filename="course-details.pdf">
                    {
                        ({ toPdf }) => <button className='btn text-white bg-indigo-500 hover:bg-indigo-700 border-0 absolute right-2 top-2' onClick={toPdf}>
                    ...
                    <div className='bg-indigo-100 p-2 text-left'>
                        ...
                        <div className="text-left leading-8">
                            ...
                            <div className='flex justify-center'>
                                <Link to={`/course/checkout/${ id }`} className="btn text-white bg-indigo-800 hover:bg-indigo-900 border-0 w-1/2">
