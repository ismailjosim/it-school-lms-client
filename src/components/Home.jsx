        ...
        <div>
            ...
            <section className="py-6 dark:bg-gray-800 dark:text-gray-100">
                <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
                    ...
                    <h1 className="text-2xl sm:text-4xl font-bold leading-none text-center">The talented people behind the scenes</h1>
                    <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
                        <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
                            ...
                            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                                <button title="Email" className="dark:text-gray-900 hover:dark:text-violet-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                                        <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                                    </svg>
                                </button>
                                <button title="Twitter" className="dark:text-gray-900 hover:dark:text-violet-400">
                                ...
                                <button title="LinkedIn" className="dark:text-gray-900 hover:dark:text-violet-400">
                                ...
                                <button title="GitHub" className="dark:text-gray-900 hover:dark:text-violet-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5">
            ...
            <section className="py-6">
                <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                    <div className="flex flex-col justify-center lg:text-left">
                        <p className="mb-1 text-sm font-medium tracking-widest uppercase dark:text-violet-400">You Can Also</p>
                        <h1 className="py-2 text-3xl font-semibold leading-tight title-font">Download Our APP</h1>
                    </div>
                    <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
                        <button className="inline-flex items-center px-6 py-3 rounded-lg text-white dark:bg-violet-600 hover:bg-violet-700">
                        ...
                        <button className="inline-flex items-center px-5 py-3 rounded-lg bg-violet-600 hover:bg-violet-700 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="fill-current w-7 h-7 dark:text-white">
            ...
            <section className="p-6 dark:bg-violet-800 dark:text-gray-100">
                <h2 className='text-3xl font-semibold'>We just keep growing</h2>
                <div className="container mx-auto grid justify-center grid-cols-2 text-center lg:grid-cols-3">
                    <div className="flex flex-col justify-start m-2 lg:m-6">
                        <p className="text-4xl font-bold leading-none lg:text-6xl">54M+</p>
                        <p className="text-sm sm:text-base">Learners</p>
                    </div>
                    <div className="flex flex-col justify-start m-2 lg:m-6">
                        <p className="text-4xl font-bold leading-none lg:text-6xl">89K</p>
                        <p className="text-sm sm:text-base">Instructors</p>
                    </div>
                    <div className="flex flex-col justify-start m-2 lg:m-6">
                    ...
                    <div className="flex flex-col justify-start m-2 lg:m-6">
                        <p className="text-4xl font-bold leading-none lg:text-6xl">12,500+</p>
                        <p className="text-sm sm:text-base">Enterprise customers</p>
                    </div>
                    <div className="flex flex-col justify-start m-2 lg:m-6">
                        <p className="text-4xl font-bold leading-none lg:text-6xl">741M+</p>
                        <p className="text-sm sm:text-base">Course enrollments</p>
                    </div>
                </div>
            </section>

            <section>
                <div className="p-6 py-12 dark:bg-gray-800">
                    <div className="container mx-auto">
                        <div className="flex flex-col lg:flex-row items-center justify-between">
                            ...
                            <Link to="/courses" className="px-5 mt-4 lg:mt-0 py-3 rounded-md border block dark:bg-gray-50 dark:text-gray-900 dark:border-gray-400">Enroll Now</Link>
                        </div>
                    </div>
                </div>
            </section>
